...
var style_ZoneName2 = function(feature, resolution){
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.4 + size,
            stroke: new ol.style.Stroke({color: "rgba(0,0,0,0.0)", lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: "rgba(135,252,143,0.0)"})})
    })];
    ...
    if (!styleCache_ZoneName2[key]){
        var text = new ol.style.Text({
              font: '14.625px Calibri,sans-serif',
              text: labelText,
              textBaseline: "center",
              textAlign: "left",
              offsetX: 5,
